          ...
          <d-col>
            <d-form>
              ...
              <d-form-row>
                ...
                <!-- Password -->
                <d-col md="6" class="form-group">
                  <label for="fePassword">Site</label>
                  <d-form-input  type="text" placeholder="Last Name" value="EX@MPL#P@$$w0RD" />
                </d-col>
              ...
              <div class="form-group">
                <label for="feInputAddress">Lieu Habitation</label>
              ...
              <d-form-row>
                <!-- City -->
                <d-col md="6" class="form-group">
                  <label for="feInputCity">Nombre heure de travail</label>
                  <d-form-input type="text" id="feInputCity" />
                </d-col>

                <!-- State -->
                <d-col md="4" class="form-group">
                  <label for="feInputState">Service</label>
